  ...
  const handleSubmit = (e) => {
    ...
    .then(res=>{
      if(res.data.insertedId){
          ...
          toast.success('Your Message Recive')
  ...
  return (
    <div>
      ...
      <div className="mt-10">
        <h2>Contact Us</h2>
        <p>
          If you have any questions or inquiries regarding our medical camp, please use the
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative mb-4  form-control mt-5 h-10 w-full min-w-[200px]">
              <input
              name="name"
            ...
            <div className="relative form-control h-10 w-full min-w-[200px]">
              <input
              name="email"
            ...
            <div className="relative h-10 mt-5 mb-4 w-full min-w-[200px]">
              <input
              name="message"
                  required
                className="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            ...
            <button className="btn w-full bg-yellow-400" type="submit">Submit</button>
          </form>
        )}
      </div>
    </div>
