...
const UpCard = ({camp}) => {
    ...
    return (
        <div className="card text-white bg-gradient-to-tr from-red-500 to-green-400   bg-base-100 shadow-xl">
  ...
  <Link className="btn bg-yellow-300 w-full text-white" to={`/upComingdetails/${_id}`}> <button >Details</button></Link>
  </div>
  </div>
</div>
    );
